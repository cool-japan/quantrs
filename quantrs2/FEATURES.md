...
[dependencies]
quantrs2 = { version = "0.1.0", default-features = false }
```
...
# Only what you need
[dependencies]
quantrs2 = { version = "0.1.0", features = ["circuit", "symengine"] }
```
...
quantrs2 = { version = "0.1.0", features = ["sim", "ml"] }

[target.'cfg(target_os = "macos")'.dependencies]
quantrs2 = { version = "0.1.0", features = ["device"] }
```
