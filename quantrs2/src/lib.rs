...
quantrs2 = { version = "0.1.0-rc.2", features = ["circuit", "sim", "ml"] }
```
...
// Requires: quantrs2 = { version = "0.1.0-rc.2", features = ["circuit", "sim"] }
...
// Requires: quantrs2 = { version = "0.1.0-rc.2", features = ["ml"] }
...
// Requires: quantrs2 = { version = "0.1.0-rc.2", features = ["anneal"] }
...
```toml
[dependencies]
quantrs2 = { version = "0.1.0-rc.2", features = ["device", "circuit"] }
```
...
**Breaking Changes in 0.1.0-rc.2**:
...
- **v0.1.0-rc.2**: Final API stabilization, performance benchmarks
...
/// # Version Constants
///
/// - `VERSION` - QuantRS2 version (e.g., "0.1.0-rc.2")
