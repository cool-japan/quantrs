...
quantrs2 = { version = "0.2.0", features = ["circuit", "sim", "ml"] }
```
...
// Requires: quantrs2 = { version = "0.2.0", features = ["circuit", "sim"] }
...
// Requires: quantrs2 = { version = "0.2.0", features = ["ml"] }
...
// Requires: quantrs2 = { version = "0.2.0", features = ["anneal"] }
...
/// # Version Constants
///
/// - `VERSION` - QuantRS2 version (e.g., "0.2.0")
