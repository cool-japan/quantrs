...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Created VQE circuit with {} parameters", vqe_circuit.num_parameters());
    ...
    println!("Created UCCSD circuit with {} parameters", uccsd_circuit.num_parameters());
    ...
    println!("Custom VQE circuit with {} parameters", custom_vqe.num_parameters());
    ...
    println!("theta_0 = {:.4}", custom_vqe.get_parameter("theta_0").unwrap());
    println!("phi_1 = {:.4}", custom_vqe.get_parameter("phi_1").unwrap());
    println!("theta_2 = {:.4}", custom_vqe.get_parameter("theta_2").unwrap());
    ...
    println!("Created optimizer with max iterations: {}", optimizer.max_iterations);
    ...
    let optimizers = vec![
        ...
        ("Adam", VQEOptimizerType::Adam { beta1: 0.9, beta2: 0.999 }),
        ("BFGS", VQEOptimizerType::BFGS),
        ("Nelder-Mead", VQEOptimizerType::NelderMead),
        ("SPSA", VQEOptimizerType::SPSA { alpha: 0.602, gamma: 0.101 }),
    ];
    ...
    println!("Real-space circuit with {} parameters", real_space_circuit.num_parameters());
    ...
    println!("Molecular Hamiltonian with {} terms", molecular_ham.terms.len());
