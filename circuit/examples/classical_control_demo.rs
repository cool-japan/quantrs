...
fn simple_conditional() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Created circuit with {} operations", circuit.num_operations());
...
fn quantum_teleportation() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Created teleportation circuit with {} operations", 
...
fn adaptive_phase_estimation() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("Created adaptive phase estimation circuit with {} operations", 
