...
fn matrix_multiply_2x2(a: &Vec<Vec<Complex64>>, b: &Vec<Vec<Complex64>>) -> Vec<Vec<Complex64>> {
    vec![
        vec![
...
impl GraphOptimizer {
    ...
    fn identify_gate(&self, matrix: &Vec<Vec<Complex64>>) -> Option<(String, Vec<f64>)> {
    ...
    fn is_pauli_x(&self, matrix: &Vec<Vec<Complex64>>, tol: f64) -> bool {
        matrix.len() == 2
            && matrix[0].len() == 2
            && (matrix[0][0].norm() < tol)
    ...
    fn is_pauli_y(&self, matrix: &Vec<Vec<Complex64>>, tol: f64) -> bool {
        matrix.len() == 2
            && matrix[0].len() == 2
            && (matrix[0][0].norm() < tol)
    ...
    fn is_pauli_z(&self, matrix: &Vec<Vec<Complex64>>, tol: f64) -> bool {
        matrix.len() == 2
            && matrix[0].len() == 2
    ...
    fn is_hadamard(&self, matrix: &Vec<Vec<Complex64>>, tol: f64) -> bool {
    ...
    fn is_rz(&self, matrix: &Vec<Vec<Complex64>>, tol: f64) -> Option<f64> {
        if matrix.len() != 2
            || matrix[0].len() != 2
            || matrix[0][1].norm() > tol
            || matrix[1][0].norm() > tol
