...
pub fn reconstruct_maximum_likelihood(
    ...
    let optimization_result: Result<super::super::fallback::OptimizeResult, crate::DeviceError> = Ok(super::super::fallback::OptimizeResult {
    ...
    let log_likelihood = -calculate_negative_log_likelihood(
        &optimized_process,
        experimental_data,
        tomographer,
    )?;
