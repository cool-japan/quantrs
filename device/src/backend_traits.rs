...
use crate::translation::{HardwareBackend, NativeGateSet, DecomposedGate};
    ...
    impl GateOp for SycamoreGate {
        ...
        fn matrix(&self) -> QuantRS2Result<Vec<Complex64>> {
            ...
            Ok(vec![
                ...
                Complex64::new(0.0, 0.0), Complex64::new(c, 0.0), s, Complex64::new(0.0, 0.0),
                Complex64::new(0.0, 0.0), s, Complex64::new(c, 0.0), Complex64::new(0.0, 0.0),
...
pub mod ionq_gates {
    ...
    impl GateOp for XXGate {
        ...
        fn matrix(&self) -> QuantRS2Result<Vec<Complex64>> {
            ...
            Ok(vec![
                Complex64::new(c, 0.0), Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0), s,
                Complex64::new(0.0, 0.0), Complex64::new(c, 0.0), s, Complex64::new(0.0, 0.0),
                Complex64::new(0.0, 0.0), s, Complex64::new(c, 0.0), Complex64::new(0.0, 0.0),
                s, Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0), Complex64::new(c, 0.0),
            ])
        }
...
pub mod honeywell_gates {
    ...
    impl GateOp for ZZGate {
        ...
        fn matrix(&self) -> QuantRS2Result<Vec<Complex64>> {
            ...
            Ok(vec![
                phase_m, Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0),
                Complex64::new(0.0, 0.0), phase_p, Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0),
                Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0), phase_p, Complex64::new(0.0, 0.0),
                Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0), Complex64::new(0.0, 0.0), phase_m,
            ])
        }
    ...
    match backend {
        HardwareBackend::IBMQuantum => BackendCapabilities {
            ...
            native_gates: NativeGateSet {
                backend,
                single_qubit_gates: vec!["id", "rz", "sx", "x"].iter().map(|s| s.to_string()).collect(),
        ...
        HardwareBackend::IonQ => BackendCapabilities {
            ...
            native_gates: NativeGateSet {
                backend,
                single_qubit_gates: vec!["rx", "ry", "rz"].iter().map(|s| s.to_string()).collect(),
