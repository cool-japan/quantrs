...
pub use gate_fusion::{
    GateFusionEngine, FusionRule, FusedGateSequence, apply_gate_fusion
};
pub use circuit_optimization::{
    CircuitOptimizer, OptimizationLevel, CircuitMetrics, optimize_circuit
};
pub use adaptive_precision::{
    AdaptivePrecisionManager, PrecisionLevel, adapt_precision_for_circuit
};
pub use quantum_cache::{
    StableQuantumCache, CacheKey, CachedResult, get_global_cache
};
pub use simd_gates::{
    SIMDGateProcessor, VectorizedOperation, process_gates_simd
};
