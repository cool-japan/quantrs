...
pub mod essentials {
    ...
    pub use crate::api::quantum::{QubitId, Register, GateOp};
    pub use crate::api::quantum::{QuantumOperation, MeasurementOutcome};
    pub use crate::api::quantum::{QuantRS2Error, QuantRS2Result};
    
    // Basic mathematical operations
    pub use crate::api::math::{QuantumMatrix, DenseMatrix, tensor_product_many};
...
#[deprecated(since = "1.0.0", note = "Use organized modules like `essentials`, `algorithms`, etc.")]
pub mod legacy {
