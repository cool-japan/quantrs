...
fn larger_system_example() {
    ...
    let matrix = Array2::from_shape_vec((4, 4), vec![
        Complex64::new(4.0, 0.0), Complex64::new(1.0, 0.0), Complex64::new(0.0, 0.0), Complex64::new(0.5, 0.0),
        Complex64::new(1.0, 0.0), Complex64::new(4.0, 0.0), Complex64::new(0.5, 0.0), Complex64::new(0.0, 0.0),
        Complex64::new(0.0, 0.0), Complex64::new(0.5, 0.0), Complex64::new(4.0, 0.0), Complex64::new(1.0, 0.0),
        Complex64::new(0.5, 0.0), Complex64::new(0.0, 0.0), Complex64::new(1.0, 0.0), Complex64::new(4.0, 0.0),
    ]).unwrap();
