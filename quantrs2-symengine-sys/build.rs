...
fn generate_bindings() {
    let mut builder = bindgen::Builder::default()
        ...
        .allowlist_function("function_symbol_.*")
        // Type allowlist
        .allowlist_type("basic_struct")
        .allowlist_type("CVecBasic")
        .allowlist_type("CSetBasic")
        .allowlist_type("CMapBasicBasic")
        .allowlist_type("CDenseMatrix")
        .allowlist_type("CSparseMatrix")
        .allowlist_type("dcomplex")
        .allowlist_type("symengine_exceptions_t")
