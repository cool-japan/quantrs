...
impl OptimizedSimulator {
    ...
    pub fn with_options(use_simd: bool, memory_efficient: bool, memory_efficient_threshold: usize) -> Self {
        Self {
            use_simd,
            memory_efficient,
...
impl<const N: usize> Simulator<N> for OptimizedSimulator {
    fn run(&self, circuit: &Circuit<N>) -> QuantrsResult<Register<N>> {
        ...
        if N >= 30 && self.memory_efficient {
            ...
            let chunked_simulator = crate::optimized_simulator_chunked::OptimizedSimulatorChunked::new();
