...
pub fn apply_x_gate_simd(
    ...
    // Simply swap the amplitudes
    for i in 0..in_amps0.len() {
        out_amps0[i] = in_amps1[i];
...
pub fn apply_single_qubit_gate_optimized(
    ...
    if *matrix == [Complex64::new(0.0, 0.0), Complex64::new(1.0, 0.0), 
                  Complex64::new(1.0, 0.0), Complex64::new(0.0, 0.0)] {
        // X gate
        apply_x_gate_simd(in_amps0, in_amps1, out_amps0, out_amps1);
        return;
    } else if *matrix == [Complex64::new(1.0, 0.0), Complex64::new(0.0, 0.0), 
...
mod tests {
    ...
    fn test_x_gate_scalar() {
        ...
        // Apply gate
        apply_single_qubit_gate_scalar(&x_matrix, &in_amps0, &in_amps1, &mut out_amps0, &mut out_amps1);
    ...
    fn test_hadamard_gate_scalar() {
        ...
        // Apply gate
        apply_single_qubit_gate_scalar(&h_matrix, &in_amps0, &in_amps1, &mut out_amps0, &mut out_amps1);
    ...
    fn test_optimized_gate_wrapper() {
        ...
        apply_single_qubit_gate_optimized(&h_matrix, &in_amps0, &in_amps1, &mut out_amps0, &mut out_amps1);
